...
# Check if any of the prompt embeddings are None and replace with an empty tensor (or zero tensor)
        if negative_prompt_embeds is None:
            negative_prompt_embeds = torch.empty(0)  # Adjust this size as needed
        if prompt_embeds is None:
            prompt_embeds = torch.empty(0)  # Adjust this size as needed
